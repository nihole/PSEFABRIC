...
par_voc = {}
par_voc['addr_par_1'] = 'addr_par_1'
par_voc['addr_par_2'] = 'addr_par_2'
par_voc['addr_par_3'] = 'addr_par_3'
par_voc['addr_par_4'] = 'addr_par_4'
par_voc['addr_par_5'] = 'addr_par_5'
par_voc['addr_par_6'] = 'addr_par_6'

par_voc['addrset_par_1'] = 'addrset_par_1'
par_voc['addrset_par_2'] = 'addrset_par_2'
par_voc['addrset_par_3'] = 'addrset_par_3'
par_voc['addrset_par_4'] = 'addrset_par_4'
par_voc['addrset_par_5'] = 'addrset_par_5'
par_voc['addrset_par_6'] = 'addrset_par_6'

par_voc['svc_par_1'] = 'svc_par_1'
par_voc['svc_par_2'] = 'svc_par_2'
par_voc['svc_par_3'] = 'svc_par_3'
par_voc['svc_par_4'] = 'svc_par_4'
par_voc['svc_par_5'] = 'svc_par_5'
par_voc['svc_par_6'] = 'svc_par_6'

par_voc['svcset_par_1'] = 'svcset_par_1'
par_voc['svcset_par_2'] = 'svcset_par_2'
par_voc['svcset_par_3'] = 'svcset_par_3'
par_voc['svcset_par_4'] = 'svcset_par_4'
par_voc['svcset_par_5'] = 'svcset_par_5'
par_voc['svcset_par_6'] = 'svcset_par_6'

par_voc['app_par_1'] = 'app_par_1'
par_voc['app_par_2'] = 'app_par_2'
par_voc['app_par_3'] = 'app_par_3'
par_voc['app_par_4'] = 'app_par_4'
par_voc['app_par_5'] = 'app_par_5'
par_voc['app_par_6'] = 'app_par_6'

par_voc['appset_par_1'] = 'appset_par_1'
par_voc['appset_par_2'] = 'appset_par_2'
par_voc['appset_par_3'] = 'appset_par_3'
par_voc['appset_par_4'] = 'appset_par_4'
par_voc['appset_par_5'] = 'appset_par_5'
par_voc['appset_par_6'] = 'appset_par_6'

par_voc['plc_par_1'] = 'plc_par_1'
par_voc['plc_par_2'] = 'plc_par_2'
par_voc['plc_par_3'] = 'plc_par_3'
par_voc['plc_par_4'] = 'plc_par_4'
