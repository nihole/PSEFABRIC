...
PSEFABRIC allows you to see the entire network as a whole and manage it as a single device and at the same time this 
...
- project p001 shows how this approach can be implemented for Cisco Routers/Switches, Cisco ASA and Juniper FWs environment 
